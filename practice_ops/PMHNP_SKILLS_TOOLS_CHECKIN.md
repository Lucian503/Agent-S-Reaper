...
- Generated: 2026-08-18 19:07:12 UTC
- Practice Profile: Solo PMHNP outpatient practice

## 1) Mission
Continuously collect and curate skills and tools that improve prior authorizations, clinical documentation, scheduling, billing readiness, and patient communication workflows.

## 2) Capability Status
- Cloud PMHNP skills/tool collection in GitHub: READY
- Desktop EHR/CoverMyMeds interaction from this cloud workflow: BLOCKED
- Prior-auth execution readiness on local desktop agent: PARTIAL
...
- [ai-summer2025/prior-auth-agent](https://github.com/ai-summer2025/prior-auth-agent) | stars=0 | lang=Python | updated=2026-08-18T18:46:32Z | Agentic prior authorization automation system for healthcare — state machine, criteria evaluation, appeal drafting, and audit trail.
- [api-evangelist/silna](https://github.com/api-evangelist/silna) | stars=0 | lang=Unknown | updated=2026-08-16T16:57:28Z | Silna Health is a healthcare automation platform that handles prior authorizations, benefit checks, eligibility verification, and insurance monitoring upfront so providers can confirm patients are clear to receive care.
- [api-evangelist/clicks](https://github.com/api-evangelist/clicks) | stars=0 | lang=Unknown | updated=2026-08-16T14:33:35Z | Clicks (Clicks Health) is an AI-native operations company that deploys AI agents to run complete healthcare back-office workflows. Its agents handle revenue cycle management (eligibility and insurance verification, prior authorization, claim status checking, denials management, and patient refunds), patient access, and other repetitive tasks by…
- [api-evangelist/candid-health](https://github.com/api-evangelist/candid-health) | stars=0 | lang=Unknown | updated=2026-08-16T14:31:41Z | Candid Health is a medical billing automation platform providing REST APIs for submitting claims, checking real-time eligibility, managing encounters, processing remittances, handling prior authorizations, patient collections, credentialing, and full revenue cycle management for healthcare providers.
- [api-evangelist/bookend](https://github.com/api-evangelist/bookend) | stars=0 | lang=Unknown | updated=2026-08-16T14:31:06Z | Bookend AI is a healthcare automation company building a Gastroenterology Practice Automation Platform that combines Payer Policy Intelligence with intelligent workflow automation. Its Universal Policy Library aggregates and interprets prior authorization, eligibility, benefits, and reimbursement requirements from hundreds of medical and pharmacy…
...
- [api-evangelist/roger](https://github.com/api-evangelist/roger) | stars=0 | lang=Unknown | updated=2026-08-16T16:55:32Z | Roger (operated by Sanos Services GmbH, Berlin, Germany) is a B2B SaaS practice-management platform for dental clinics. It layers automation and AI onto existing German dental practice-management systems (PVS) such as CGM Z1, Charly, Dampsoft, Evident and Dento Office, adding patient recall, digital intake forms, WhatsApp/SMS communication…
- [ncreighton/80b0eaf3-healthcare-medical-client-on](https://github.com/ncreighton/80b0eaf3-healthcare-medical-client-on) | stars=0 | lang=Unknown | updated=2026-08-05T19:15:40Z | Your medical practice is drowning in manual patient intake forms, redundant data entry, and compliance bottlenecks that delay care. The Healthcare & Medical Client Onboarding Automation N8N Workflow eliminates these friction points entirely—automating every step from patient inquiry to verified enrollment while maintaining HIPAA compliance.  This i
...
- [api-evangelist/klara](https://github.com/api-evangelist/klara) | stars=0 | lang=Unknown | updated=2026-08-16T15:36:51Z | Klara is a US healthcare patient-engagement and communication platform, now part of Modernizing Medicine (ModMed), that gives medical practices two-way secure messaging, patient texting, appointment reminders and scheduling, intake and forms, telemedicine, and automated workflow tools to reduce phone volume and staff workload.
...
- Parse patient selector in LastName, FirstName format and disambiguate with DOB/MRN when needed.
- Extract demographic fields required for prior authorization workflows.
- Extract diagnosis and ICD-10 data relevant to the medication request.
- Map extracted values to target form fields with validation checks before submit.
- Use human-like input pacing and section-by-section review in portal form entry.
- Require explicit user confirmation before final healthcare submission actions.

## 5) Next Curation Actions
- Track high-signal tools with active maintenance and healthcare relevance.
- Promote tools to implementation candidates only after manual review.
- Prioritize workflows that reduce time to prior-auth submission and reduce charting burden.

## 6) Guardrails
- Do not submit clinical or payer data from cloud automation without explicit human approval.
- Use local authenticated sessions for final healthcare portal actions.
